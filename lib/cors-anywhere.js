...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['http://localhost','https://herokuapp.com','https://defenseid.herokuapp.com/','https://www.test-cors.org/'],            // If non-empty, requests not from an origin in this list will be blocked.
